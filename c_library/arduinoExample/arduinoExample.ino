...
void setup() {
  ...
  for (int cal_int = 0; cal_int < 3000; cal_int ++){
    ...
    // read_mpu_6050_data();
    mpu9250.readData();
    gyro_x_cal += mpu9250.gyro.x;
    gyro_y_cal += mpu9250.gyro.y;
    gyro_z_cal += mpu9250.gyro.z;
...
void loop() {
  ...
  Serial.print(mpu9250.gyro.x,2); Serial.print(",");
  Serial.print(mpu9250.gyro.y,2); Serial.print(",");
  Serial.print(mpu9250.gyro.z,2); Serial.print(",");
  Serial.print(mpu9250.acc.x,2); Serial.print(",");
  Serial.print(mpu9250.acc.y,2); Serial.print(",");
  Serial.println(mpu9250.acc.z,2);
